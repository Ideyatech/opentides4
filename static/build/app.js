...
angular.module('app.class').controller('ClassInfoCtrl', function () {
...
angular.module('app.student').controller('StudentProfiletCtrl', function () {
...
angular.module('app.teacher').controller('TeacherListCtrl', function () {
...
angular.module('app.teacher').controller('TeacherProfiletCtrl', function () {
